...
namespace Day34Concepts.ExceptionHandlingTypes
{
    ...
    public class ExceptionTypes
    {
        public static void ExceptionTypesExample1()
        {
            try
            {
                Console.WriteLine(ExceptionHandlingTypes.Divide(10, 0));
            ...
            catch (DivideByZeroException ex)
            {
                ...
                Console.WriteLine(ExceptionHandlingTypes.Divide(10, 1));
            }
            catch (Exception ex)
            {
        ...
        public static void ExceptionTypesExample2()
        {
            try
            {
                Console.WriteLine(ExceptionHandlingTypes.Arithmetic(10, 0));

            }
            catch (Exception ex)
            {
                Console.WriteLine("Error Has Occured Sorry"); 
        ...
        public static void ExceptionTypesExample3()
        {
            try
            {
                Console.WriteLine(ExceptionHandlingTypes.Divide2(-1, 0));
        ...
        public static void ExceptionTypesExample4()
        {
            try
            {
                Console.WriteLine(ExceptionHandlingTypes.Arithmetic2(-1, 1));
            }
            ...
            {
                Console.WriteLine("Dividing by Zero Not Possible: Correct it to 1"); 
        ...
        public static void ExceptionTypesExample5()
        {
            try
            {
                Console.WriteLine(ExceptionHandlingTypes.Arithmetic3(-1, 1));
            }
