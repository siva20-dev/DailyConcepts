...
namespace Day12Concepts.ListClassFunctions
{
    public class ListClassFunctionsConcepts
    {
        public static void ListClassContainsFunctionExamples()
        {
        ...
        public static void FindingItemsInAList()
        {
            List<Customer> customers = CustomerTestData.GetCustomers();

            Customer E = customers.Find(cust => cust.Salary > 5000); //Find 
        ...
        public static void ConvertingListToDictionary()
        {
            List<Customer> customers = CustomerTestData.GetCustomers();
